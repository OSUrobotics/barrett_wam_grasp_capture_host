...
if __name__ == "__main__":
    ...
    rs1_pub = rospy.Publisher("/grasp_cloud/rs1", PointCloud2, queue_size=1, latch=True)
    rs2_pub = rospy.Publisher("/grasp_cloud/rs2", PointCloud2, queue_size=1, latch=True)
    ...
    while not rospy.is_shutdown():
        ...
        for topic, msg, t in extreme_bag.read_messages(topics=[grasp_extreme_topic]):
            ...
            rs1_pub.publish(msg.realsense_feed1)
            rs2_pub.publish(msg.realsense_feed2)
